...
return goog.dom.classlist.remove(cljs.core.first.call(null,document.getElementsByClassName("navbar-collapse")),"show");
});
static_website.core.highlight_menu = (function static_website$core$highlight_menu(no){
var elements_528 = document.querySelectorAll(".navbar .navbar-nav > .nav-item");
...
var elements_529 = document.querySelectorAll(".cd-hero-slider li");
goog.dom.classlist.add(cljs.core.first.call(null,elements_529),"hidden");

goog.dom.classlist.add(cljs.core.second.call(null,elements_529),"hidden");

goog.dom.classlist.add(cljs.core.second.call(null,cljs.core.rest.call(null,elements_529)),"hidden");

goog.dom.classlist.add(cljs.core.last.call(null,elements_529),"hidden");
...
var elements_530 = document.querySelectorAll(".navbar .navbar-nav > .nav-item");
static_website.core.add_event.call(null,cljs.core.first.call(null,elements_530),goog.events.EventType.CLICK,static_website.core.change_page);

static_website.core.add_event.call(null,cljs.core.second.call(null,elements_530),goog.events.EventType.CLICK,static_website.core.change_page);

static_website.core.add_event.call(null,cljs.core.second.call(null,cljs.core.rest.call(null,elements_530)),goog.events.EventType.CLICK,static_website.core.change_page);

static_website.core.add_event.call(null,cljs.core.last.call(null,elements_530),goog.events.EventType.CLICK,static_website.core.change_page);
